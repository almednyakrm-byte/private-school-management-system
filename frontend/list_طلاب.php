...
<body class="bg-slate-900 text-white">
    ...
    <main class="container mx-auto p-4 pt-6 md:p-6 lg:p-12 xl:p-24">
        ...
        <table id="table" class="w-full text-white border border-slate-800">
            <thead>
                <tr>
            ...
            .then(data => {
                ...
                data.forEach(item => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-4 py-2">
                            <a href="edit_طلاب.php?id=${item.id}" class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">Edit</a>
                            <button class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded" onclick="deleteItem(${item.id})">Delete</button>
                        </td>
                    `;
